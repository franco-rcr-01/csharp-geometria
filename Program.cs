...
namespace csharp_geometria // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        ...
        {
            /* Per chiamare i metodi della classe di lettura dei numeri
                int v;
                LeggiNumeri.ReadNum("inserire un numero: ", out v);
                Console.WriteLine("Letto: {0}", v);

                Console.Write("Inserire un altro numero: ");
                LeggiNumeri.ReadNum(out v);
                Console.WriteLine("Letto: {0}", v);

                long lv;
                LeggiNumeri.ReadNum("inserire un numero grande: ", out lv);
                Console.WriteLine("Letto: {0}", lv);

                double dv;
                LeggiNumeri.ReadNum("inserire un numero grande decimale: ", out dv);
                Console.WriteLine("Letto: {0}", dv);
            */
